...
export default function RequestDetailScreen() {
  ...
  const { data: request, isLoading, isError, error, refetch } = useGetRequestQuery(id as string);
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              showError(err as any, "Failed to accept request");
            }
          },
        },
      ]
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              showError(err as any, "Failed to update status");
            }
          },
        },
      ]
