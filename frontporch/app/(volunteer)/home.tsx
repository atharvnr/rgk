...
export default function StudentHomeScreen() {
  ...
  const { data: sessionsData, isLoading: sessionsLoading, isError: sessionsError, error: sessionsErr, refetch: refetchSessions } =
  ...
  if (userError || sessionsError) {
    return (
      <ErrorState
        description={getErrorMessage(userErr || sessionsErr)}
        onRetry={() => { refetchUser(); refetchSessions(); }}
      />
    );
  }
